...
{
  interfaces__msg__Motor * msg = (interfaces__msg__Motor *)malloc(sizeof(interfaces__msg__Motor));
  if (!msg) {
    return NULL;
  }
...
interfaces__msg__Motor__Sequence__init(interfaces__msg__Motor__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__msg__Motor *)calloc(size, sizeof(interfaces__msg__Motor));
    if (!data) {
      return false;
    }
...
{
  interfaces__msg__Motor__Sequence * array = (interfaces__msg__Motor__Sequence *)malloc(sizeof(interfaces__msg__Motor__Sequence));
  if (!array) {
    return NULL;
  }
